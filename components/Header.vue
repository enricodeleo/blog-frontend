    ...
    <nav class="container max-w-screen-xl mx-auto flex flex-col lg:flex-row justify-between">
      ...
      <div class="flex flex-col lg:flex lg:flex-row lg:items-center" :class="{ hidden: !expanded }">
        <a
          ...
          target="_blank"
          class="text-gray-600 hover:text-blue-500 text-sm mr-3 py-2"
        >
        ...
        <a
          ...
          target="_blank"
          class="text-gray-600 hover:text-pink-500 text-sm mr-3 py-2"
        >
        ...
        <a
          ...
          target="_blank"
          class="text-gray-600 hover:text-blue-800 text-sm mr-3 py-2"
        >
        ...
        <a
          ...
          target="_blank"
          class="text-gray-600 hover:text-black text-sm mr-3 py-2"
        >
